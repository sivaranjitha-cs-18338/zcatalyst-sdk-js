...
/**
 * Browser client for invoking deployed Catalyst serverless functions.
 *
 * @example
 * ```ts
...
export class Functions implements Component {
	...
	/** Creates a browser Functions client bound to the optional Catalyst app instance. */
	...
	/**
	 * Executes a deployed Catalyst function by ID or name from a browser context.
